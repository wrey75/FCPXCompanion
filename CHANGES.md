...
* feat (0.97.3): new detected librairies are added at the beginning of the list (rather then the end).

v0.98.0
-------

* fix (0.98.0): the calcultation of proxy files in case of symbolic links.
